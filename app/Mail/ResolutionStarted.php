...
class ResolutionStarted extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Resolution Started',

            tags: ['Resolution Started'],
            metadata: [
    ...
    public function content(): Content
    {
        return new Content(
            ...
            markdown: 'emails.resolutions.started',
            with: [
    ...
    {
        return [];  // attach annotated resolution pack
    }
}
