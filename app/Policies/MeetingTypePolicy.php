...
class MeetingTypePolicy
{
    ...
    {
        return $user->hasPermissionTo('list meeting_types');
    }
    ...
    public function create(User $user): bool
    {
        ...
        return $user->hasPermissionTo('create meeting_types');
    ...
    {
        return $user->hasPermissionTo('edit meeting_types');
    ...
    {
        return $user->hasPermissionTo('delete meeting_types');
