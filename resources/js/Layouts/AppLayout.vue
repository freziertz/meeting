                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-2 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('resolutions.index')" :active="route().current('resolutions.index')">
                                    Resolutions
                                </NavLink>
                                ...
                                <NavLink :href="route('actions.index')" :active="route().current('actions.index')">
                                    Actions
                                </NavLink>
                                ...
                                <NavLink :href="route('directories.index')" :active="route().current('directories.index')">
                                    Directory
                                </NavLink>
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.props.jetstream.managesProfilePhotos1" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
