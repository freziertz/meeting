                           ...
                           <div class="flex items-center justify-between mb-6">
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tr class="text-left font-bold">
                                    ...
                                    <th class="pb-4 pt-6 px-6">Start Time</th>
                                    <th class="pb-4 pt-6 px-6">End Date</th>
                                    <th class="pb-4 pt-6 px-6">End Time</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="announcement in announcements" :key="announcement.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                    <td class="border-t">
                                        <NavLink class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/announcements/${announcement.id}/edit`">
                                            {{ announcement.title }}
                                            <icon v-if="announcement.deleted_at" name="trash" class="flex-shrink-0 ml-2 w-3 h-3 fill-gray-400" />
                                        </NavLink>
                                    </td>
                                    <td class="border-t">
                                        <NavLink class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/announcements/${announcement.id}/edit`">
