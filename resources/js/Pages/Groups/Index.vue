    ...
    <AppLayout title="Groups">
        ...
        <div class="mx-4">
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                            <!-- <Head title="Groups" /> -->
                            <!-- <h1 class="mb-8 text-3xl font-bold">Groups</h1> -->
                           <div class="flex items-center justify-between mb-6">
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tr v-for="group in groups" :key="group.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                    <td class="border-t">
                                        <Link class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/groups/${group.id}/edit`">
                                            {{ group.name }}
                                            <icon v-if="group.deleted_at" name="trash" class="flex-shrink-0 ml-2 w-3 h-3 fill-gray-400" />
                                        </Link>
                                    </td>
                                ...
                                <tr v-if="groups.length === 0">
                                    <td class="px-6 py-4 border-t" colspan="4">No groups found.</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
