    ...
    <AppLayout title="Purposes">
        ...
        <div class="mx-4">
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                            <!-- <Head title="Purposes" /> -->
                            <!-- <h1 class="mb-8 text-3xl font-bold">Purposes</h1> -->
                           <div class="flex items-center justify-between mb-6">
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                <tr v-for="purpose in purposes" :key="purpose.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                    <td class="border-t">
